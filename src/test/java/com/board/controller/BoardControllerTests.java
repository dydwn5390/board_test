...
public class BoardControllerTests {
    ...
    public void tetGet() throws Exception {
        ...
        log.info(mockMvc.perform(MockMvcRequestBuilders.get("/board/get").param("bno", "144")).andReturn()
    ...
    public void testModify() throws Exception {
        ...
        String resultPage = mockMvc
                .perform(MockMvcRequestBuilders.post("/board/modify").param("bno", "144").param("title", "수정된 테스트 새글 제목")
